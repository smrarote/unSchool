/*
  ...
  - Added the required column `social` to the `users` table without a default value. This is not possible if the table is not empty.
...
ADD COLUMN     "social" JSON NOT NULL,
